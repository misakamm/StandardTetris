...
#ifndef STStrategyRogerLLimaLaurentBercotSebastienBlondeelOnePiece1996Header
#define STStrategyRogerLLimaLaurentBercotSebastienBlondeelOnePiece1996Header
...
namespace CPF
{
	namespace StandardTetris
	{
		...
		class STStrategyRogerLLimaLaurentBercotSebastienBlondeelOnePiece1996 : public STStrategy
		{
		...
		private: static float PrivateStrategy
					 ( 
		...
		private: static float PrivateStrategyEvaluate
					 ( 
					 STBoard &    board,
					 int droppedPieceRow
					 );
